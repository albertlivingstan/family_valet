...
import { Camera, User, Mail, Lock, AlertCircle, ArrowRight } from "lucide-react";
    ...
    <div className="flex items-center justify-center min-h-[75vh] px-4">
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl shadow-2xl space-y-6 relative overflow-hidden">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Register in your secure family vault</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="p-3 bg-amber-500/5 border border-amber-500/10 rounded-xl text-[10px] text-amber-400 font-medium leading-relaxed">
            Note: New accounts require approval from an existing family Admin before accessing family-shared photos.
          </div>
        ...
        <div className="relative flex items-center my-4">
          ...
          <span className="flex-shrink mx-3 text-[10px] uppercase font-bold text-slate-500 tracking-widest">Or Register With</span>
          <div className="flex-grow border-t border-white/5"></div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-slate-200 text-sm font-semibold transition-all flex items-center justify-center gap-2.5"
        >
