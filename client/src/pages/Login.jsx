...
import { Camera, Mail, Lock, AlertCircle, ArrowRight } from "lucide-react";
    ...
    <div className="flex items-center justify-center min-h-[70vh] px-4">
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl shadow-2xl space-y-6 relative overflow-hidden">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Unlock your private family memories</p>
        </div>
        ...
        <div className="relative flex items-center my-4">
          ...
          <span className="flex-shrink mx-3 text-[10px] uppercase font-bold text-slate-500 tracking-widest">Or Continue With</span>
          <div className="flex-grow border-t border-white/5"></div>
        </div>
